...
//    }
    ...
    public function signin(){
        ...
        if(!$result->num_rows>0)
        {
            $queryinsert="select user.userid as adminid,user.usergroup_id,user.nickname as username,grouprights.cms_model from user LEFT JOIN grouprights ON grouprights.usergroup_id=user.usergroup_id where "
                . "user.nickname='$this->username' and"
         ...
         if($data->cms_model==0){
            throw new Exception("Sorry you dont have permission to login cms panel");
         }
         else {
            ...
            $_SESSION['cms_model']= $data->cms_model;
