        ...
        <div class="col-md-6">
            <form class="form-horizontal" action="process/adduserprocess.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10 col-md-8">
                        <input type="password" class="form-control" value="" minlength="8" required=""  placeholder="Password" name="password">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2 col-md-4" >Confirm Password:</label>
                    <div class="col-sm-10 col-md-8">
                        <input type="password" class="form-control" value="" minlength="8" required=""  placeholder="Confirm password" name="cpassword">
                    </div>
                </div>
                <div class="form-group">
