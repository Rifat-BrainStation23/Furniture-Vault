                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            <tr class="gradeU" id="rowid<?=$data->userid;?>">
                                ...
                                <td>
                                    <a id="approvebtn<?=$data->userid?>" href="javascript:" onclick="approveuser('<?=$data->userid?>','1')">Approve</a>&nbsp;
                                    <a id="disapprovebtn<?=$data->userid?>" href="javascript:" onclick="approveuser('<?=$data->userid?>','2')">Disapprove</a>
                                </td>
                            </tr>
                            <?php  
                            $i++;
