    ...
    <body>
        ...
        <div id="wrap">
            ...
            <div id="registration_block">
                ...
                <div class="form">
                    <p>Thank you. Your account created, but your registration is still incomplete. Follow the instructions in your mailbox to complete registration</p>
                    <p>If you haven't received email, 
                        <a href="http://3dsky.org/register/reconfirm_email">re-request</a> it
                    </p>
                </div>
            </div>
